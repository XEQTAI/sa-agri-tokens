// SA Agri Tokens - Interactive JavaScript
...
// Observe feature cards, token cards
document.querySelectorAll('.feature-card, .token-card, .step').forEach(el => {
    el.style.opacity = '0';
...
// Dynamic token price updates (demo)
...
// Update prices every 5 seconds (demo only)
if (document.querySelector('.token-price')) {
    setInterval(updateTokenPrices, 5000);
}

console.log('🌾 SA Agri Tokens - Website loaded successfully!');